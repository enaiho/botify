...
var sideBar = function(role){
  ...
  var bar = "";
  if(role == 1)
    bar = "<div class='sidebar' data-color='purple' data-image='/img/sidebar-1.jpg'><div class='logo'><img src='' style='width:10%;height:auto' /></div><div class='sidebar-wrapper'><ul class='nav'>  <li><a href='/bots'><i class='material-icons'>bubble_chart</i><p>Bots</p></a></li>  <li><a href='/dashboard'><i class='material-icons'>dashboard</i><p>Dashboard</p></a></li>  <li><a href='/integrations'><i class='material-icons'>bubble_chart</i><p>Integrations</p></a></li>  <li><a href='/role_manager'><i class='material-icons'>bubble_chart</i><p>Role Manager</p></a></li>  <li><a href='/users'><i class='material-icons'>person</i><p>Users</p></a></li><li><a href='javascript:support();'><i class='material-icons'>settings</i><p>Support</p></a></li></ul></div></div>";
  else
